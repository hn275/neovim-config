" My Custom version of Deep Space - An intergalactically friendly color scheme for Vim
" Source: Brandon Siders, https://github.com/tyrannicaltoucan/vim-deep-space
" Author: Hal Nguyen
" License: MIT
...
set background=dark
let g:colors_name = 'myspace'

let g:deepspace_italics = get(g:, 'myspace_italicize', 1)
...
function! s:HL(group, fg, bg, attr)
    let l:attr = a:attr
    if !g:myspace_italicize && l:attr ==# 'italic'
        let l:attr = 'none'
    endif
...
call s:HL('Cursor',                         s:gray1,    s:gray3,    '')
...
call s:HL('CursorLineNr',                   s:gray5,    s:gray3,    'none')
call s:HL('MatchParen',                     s:cyan,     s:gray3,    'undercurl')
...
call s:HL('StatusLine',                     s:gray3,    s:gray3,    'none')
